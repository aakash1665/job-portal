...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <div class="form-group ">
      <label for="head office city">Head Office City</label>
      <input type="text" class="form-control" id="headofficecity" name="headofficecity" placeholder="head office">
    </div>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="contact" name="contact"placeholder="1234 Main St">
  </div>
