...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <div class = "borderr">
        ...
        <form method="post" action="addjobpost.php">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="jobdiscription" name="jobdiscription" placeholder="jobdiscription">
  </div>
  
   <div class="form-group">
    
    <label for="minsalary">Minimum Salary</label>
    <input type="text" class="form-control" id="minsalary" name="minsalary" placeholder="minsalary">
   ...
   <div class="form-group">
    ...
    <input type="text" class="form-control" id="maxsalary" name="maxsalary" placeholder="maxsalary">
   ...
   <div class="form-group">
    ...
    <input type="text" class="form-control" id="exprience" name="exprience" placeholder="exprience requried">
